  ...
  return (
    <div className="header-main">
      <div className="header w-full h-[120vh] flex flex-col pt-48 items-center relative text-white">
        ...
        <p className={`text-[5.5vw] ${fontRaleway.className} relative`}>
        ...
        <div className="mt-4 flex border-white border bg-[#dcdcdc2d] ps-3 py-2 pr-3 rounded-md">
          <input
            ...
            className="   outline-none rounded-3xl bg-[#dcdcdc00] text-white placeholder-white  "
          ></input>
          <IoSearchCircle className="text-yellow-100 text-4xl " />
        </div>
      </div>
    </div>
  );
